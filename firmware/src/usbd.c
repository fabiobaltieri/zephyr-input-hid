...
USBD_CONFIGURATION_DEFINE(app_usb_fs_config, attributes, CONFIG_APP_USB_MAX_POWER, &fs_cfg_desc);
USBD_CONFIGURATION_DEFINE(app_usb_hs_config, attributes, CONFIG_APP_USB_MAX_POWER, &hs_cfg_desc);
